...
with open('./results_example/X_incompleted.pkl', 'rb') as file:
...
# save this dataset
with open('./results_example/X_train_pca.pkl', 'wb') as file:
    pickle.dump(X_train_pca, file)
    
with open('./results_example/X_test_pca.pkl', 'wb') as file:
    pickle.dump(X_test_pca, file)

with open('./results_example/X_incompleted_pca.pkl', 'wb') as file:
